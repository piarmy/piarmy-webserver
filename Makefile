...
run: stop
	@docker run -d --rm -v /home/pi/images/piarmy-webserver/containerFiles:/www --network=$(DOCKER_NETWORK_NAME) -p $(DOCKER_HOST_PORT_MAPPING):$(DOCKER_CONTAINER_PORT_MAPPING) --name=$(DOCKER_TASKNAME) $(DOCKER_IMAGE_NAME)
